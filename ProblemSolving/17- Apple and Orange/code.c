...
{
	int apples_inside = 0;
	int oranges_inside = 0;
	int apples_index = 0;
	int oranges_index = 0;
	int location;

	for (apples_index = 0; apples_index < apples_count; apples_index++)
	{
		location = a + apples[apples_index];
	...
	for (oranges_index = 0; oranges_index < oranges_count; oranges_index++)
	{
		location = b + oranges[oranges_index];
		if ((location >= s) && (location <= t))
		{
			oranges_inside++;
		}
	...
	printf("%d\n%d", apples_inside, oranges_inside);
